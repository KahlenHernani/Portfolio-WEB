                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-primary">
                    <div className="space-y-6 border-border p-10 rounded-lg shadow-lg bg-secondary border-secondary text-primary">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href="/resume.pdf" download="resume.pdf" className="px-6 py-2 rounded-full border bg-secondary border-primary text-primary hover:bg-foreground hover:text-primary font-bold transition-colors duration-300 btn-lg">
                                Download CV
                            </a>
                        </div>
                    </div>
